...
--echo ###########################################################################
--echo # Setup 8.4 data dir
--echo ###########################################################################

--echo # Set different paths for --datadir
--let $SRCDATADIR=data
--let $SRCZIP=mysql_inplace_upgrade84_lctn$lctn.zip
--let $MYSQLD_DATADIR1 = $MYSQL_TMP_DIR/$SRCDATADIR
--echo # Copy the remote tablespace & DB zip files from suite location to working location.
--file_exists $MYSQLTEST_VARDIR/std_data/upgrade/$SRCZIP
--copy_file $MYSQLTEST_VARDIR/std_data/upgrade/$SRCZIP $MYSQL_TMP_DIR/$SRCZIP
--echo # Check that the file exists in the working folder.
--file_exists $MYSQL_TMP_DIR/$SRCZIP

--echo # Unzip the zip file.
--exec unzip -qo $MYSQL_TMP_DIR/$SRCZIP -d $MYSQL_TMP_DIR
...
--remove_file $MYSQL_TMP_DIR/$SRCZIP
