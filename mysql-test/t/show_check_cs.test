...
--connection con1
SET NAMES latin1;
--send SELECT GET_LOCK('t',1000) AS 'цЁцЁцЁцЁ';
--connection default
...
CREATE TABLE t1 (i CHAR(3),
                 n CHAR(20) CHARACTER SET utf8mb3 GENERATED ALWAYS AS (sha2(i,256)));
...
CREATE TABLE `t1` (
  ...
  `n` char(20) CHARACTER SET utf8mb3 GENERATED ALWAYS AS (sha2(i,256)) VIRTUAL
