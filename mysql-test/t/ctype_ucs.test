...
select sha2(name,256) from bug20536;
...
--echo #
--echo # Bug#27419181 UBSAN: MY_STRNTOLL_MB2_OR_MB4 - NAUGHTY NEGATIVES
--echo #
...
--echo #
--echo # Bug#29585648: UBSAN NEGATION OF NEGATIVE IN MY_STRTOLL10_MB2
--echo #
