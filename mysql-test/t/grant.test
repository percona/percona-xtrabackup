...
--execw $MYSQL --default-character-set=utf8mb3 --user=юзер_юзер -e "select user()"
...
--error 1
--exec $MYSQL --commands -uwl7131 -pwl7131 -e "EXIT" 2>&1
...
GRANT PROXY ON user_name_len_32_012345678901234@localhost TO proxy_sha2_0123456789@localhost;
...
DROP USER user_name_len_22_01234@localhost;
DROP USER user_name_len_32_012345678901234@localhost;
DROP USER proxy_sha2_0123456789@localhost;
...
--echo #
--echo # Bug#37003502 inconsistency in whether SHOW GRANTS quotes Function or Stored Procedure's name
--echo #
...
GRANT EXECUTE ON FUNCTION fc_test TO test;

GRANT EXECUTE ON PROCEDURE sp_test TO test;
...
GRANT EXECUTE ON FUNCTION "fc_.'`test" TO test;

GRANT EXECUTE ON PROCEDURE "sp.'`_test" TO test;

GRANT SELECT ON "t.'`1" TO test;
