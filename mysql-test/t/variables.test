...
set max_join_size=100;
--disable_warnings
# To ignore MAX_JOIN_SIZE as the no. of rows returned by SELECT in session_variables
# exceed the set value of max_join_size=100.
...
--echo #
--echo # BUG#10206 -  Transaction requiring Max_BinLog_Cache_size > 4GB always rollsback
--echo #
...
SET @@global.max_binlog_cache_size=-1;
SET @@global.max_join_size=0;
# this is an exception. since this is a new error/warning, let us stay
...
--error ER_WRONG_VALUE_FOR_VAR
SET @@sql_mode= cast(pow(2,34) as unsigned);

--echo #
--echo # Bug #59860: log-slow-admin-statements and log-slow-replica-statements not displayed
--echo #
...
--echo #
--echo # WL#7764 - Make STRICT mode for transactional SEs default in 5.7
--echo #
...
--replace_column 2 REPLICA_LOAD_TMPDIR
...
#
--echo #
--replace_result $HOST_NAME hostname
...
--echo # Bug#31372388: bool Item::evaluate(): assertion `false' failed
...
--echo #
--echo # 36625773: Align implementation of repeated preparation and
--echo #           optimization for statement classes.
--echo #
...
--echo #
--echo # Bug#36322812 - RAPID global variables accept 'OF' as valid bool value
--echo # Bug#36924845 - RAPID session variables accept 'OF' as valid bool value
--echo #
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL slow_query_log = 'O';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL slow_query_log = 'OX';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL slow_query_log = 'ONX';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL slow_query_log = 'ONN';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL slow_query_log = 'OF';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL slow_query_log = 'OFX';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL slow_query_log = 'OFFF';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL slow_query_log = 'OFFX';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL slow_query_log = 'ONF';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL slow_query_log = 'OFN';
--error ER_WRONG_VALUE_FOR_VAR
...
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'O';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'OX';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'ONX';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'ONN';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'OF';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'OFX';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'OFFF';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'OFFX';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'ONF';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'OFN';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = '1';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = '0';
--error ER_WRONG_VALUE_FOR_VAR
SET GLOBAL innodb_strict_mode = 'true';
--error ER_WRONG_VALUE_FOR_VAR
