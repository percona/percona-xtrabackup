...
let $messages =
Failed to compress the gtid_executed table
Failed to save the set of Global Transaction Identifiers
;
...
--let $my_gtid_set= `SELECT @@GLOBAL.GTID_EXECUTED`
--replace_result "$my_gtid_set" GTID_SET
--error 1
