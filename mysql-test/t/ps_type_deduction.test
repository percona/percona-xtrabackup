...
prepare s from 'select f2(?, ?)';
eval $show_trace;

prepare s from 'select f3(?, ?, ?)';
eval $show_trace;
...
--echo # Bug#34632906: Assertion 'data_type() != MYSQL_TYPE_INVALID'
...
PREPARE ps FROM "SELECT CONCAT(c, ? COLLATE utf8mb4_lt_0900_ai_ci) FROM t;";
...
--echo # Bug#35287798: Prepared statement assertion error
