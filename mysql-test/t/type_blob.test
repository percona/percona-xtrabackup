...
--echo #
--echo # Bug #18127749: OPTIMIZER SHOULD THROW AN ERROR WHEN USER USES
--echo #                COMPARISION OPERATORS ON GIS DATA
--echo #
...
--echo #
--echo # Bug#21153489 VALGRIND ERRORS IN ITEM_BOOL_FUNC2::IS_NULL 
--echo #              LEAD TO CRASH LATER
--echo #
...
--echo #
--echo # Bug#30308063 UBSAN: NULL POINTER PASSED AS ARGUMENT 2,
