...
--echo #
--echo # Bug#29337233 'LATE NULLS FILTERING' NEEDED EVEN FOR EQ_REF JOINS KEYS
--echo #
...
#EQ_REF access should be used on index ix1 in query plan
EXPLAIN
...
--echo # Bug#33630225: Bad caching of converted constants in NULL-safe compare
