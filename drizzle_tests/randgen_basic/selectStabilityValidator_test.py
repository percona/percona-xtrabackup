...
class selectStabilityValidatorTest(unittest.TestCase):
    ...
    def test_selectStabilityValidator1(self):
        test_cmd = "./gentest.pl --gendata=conf/drizzle/drizzle.zz --grammar=conf/drizzle/subquery_materialization_drizzle.yy --validators=SelectStability --queries=250 --threads=3"
...
def run_test(output_file):
    suite = unittest.TestLoader().loadTestsFromTestCase(selectStabilityValidatorTest)
