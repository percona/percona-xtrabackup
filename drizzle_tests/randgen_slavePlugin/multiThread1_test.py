...
class multithread1Test(unittest.TestCase):
    ...
    def test_multithread1(self):
        test_cmd = "./gentest.pl --gendata=conf/drizzle/translog_drizzle.zz --grammar=conf/drizzle/translog_concurrent1.yy --Reporter=DrizzleSlavePlugin  --queries=100 --threads=3"
