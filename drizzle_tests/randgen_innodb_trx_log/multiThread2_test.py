...
class multiThread2Test(unittest.TestCase):
    ...
    def test_multiThread2(self):
        test_cmd = "./gentest.pl --gendata=conf/drizzle/translog_drizzle.zz --grammar=conf/drizzle/translog_concurrent2.yy --Reporter=DrizzleInnoTrxLog  --queries=75 --threads=3"
