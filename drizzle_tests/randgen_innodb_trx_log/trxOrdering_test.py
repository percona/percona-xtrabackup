...
class trxOrderingTest(unittest.TestCase):
    ...
    def test_trxOrdering(self):
        test_cmd = "./gentest.pl --gendata=conf/drizzle/translog_ordering.zz --grammar=conf/drizzle/translog_ordering.yy --Reporter=DrizzleInnoTrxLog --threads=5  --queries=75"
