...
class multiThread3Test(unittest.TestCase):
    ...
    def test_multiThread3(self):
        test_cmd = "./gentest.pl --gendata=conf/drizzle/translog_drizzle.zz --grammar=conf/drizzle/translog_concurrent3.yy --Reporter=DrizzleTransactionLog  --queries=75 --threads=3"
