...
class multiThread2MixTest(unittest.TestCase):
    ...
    def test_multiThread2Mix(self):
        test_cmd = "./gentest.pl --gendata=conf/drizzle/translog_drizzle.zz --grammar=conf/drizzle/translog_concurrent2.yy --Reporter=DrizzleTransactionLog  --queries=50 --threads=3 --seed=time"
...
def run_test(output_file):
    suite = unittest.TestLoader().loadTestsFromTestCase(multiThread2MixTest)
