...
class singleThread3Test(unittest.TestCase):
    ...
    def test_singleThread3(self):
        test_cmd = "./gentest.pl --gendata=conf/drizzle/translog_drizzle.zz --grammar=conf/drizzle/translog_concurrent3.yy --Reporter=DrizzleTransactionLog  --queries=100 --threads=1"
...
def run_test(output_file):
    suite = unittest.TestLoader().loadTestsFromTestCase(singleThread3Test)
