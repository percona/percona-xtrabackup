...
class multiThread3MixTest(unittest.TestCase):
    ...
    def test_multiThread3Mix(self):
        test_cmd = "./gentest.pl --gendata=conf/drizzle/translog_drizzle.zz --grammar=conf/drizzle/translog_concurrent3.yy --Reporter=DrizzleSlavePlugin  --queries=50 --threads=3 --seed=time"
