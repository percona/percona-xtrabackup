 ...
 */
static bool wsrep_is_wsrep_xid(
    /*===============*/
    const void *xid_ptr) {
 ...
 */
static const wsrep_uuid_t *wsrep_xid_uuid(
    /*===========*/
    const XID *xid) {
...
/***********************************************************************/ /**
 ...
 short.
 */
static int wsrep_uuid_print(
    /*=============*/
    const wsrep_uuid_t *uuid, char *str, size_t str_len) {
  if (str_len > 36) {
...
/*==================*/
{
  ...
  if (wsrep_uuid_print(wsrep_xid_uuid(&xid), uuid_str, sizeof(uuid_str)) < 0) {
    return;
  }
