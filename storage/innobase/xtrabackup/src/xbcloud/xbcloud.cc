...
static struct my_option my_long_options[] = {
    ...
    {"s3-session-token", OPT_S3_SESSION_TOKEN, "S3 session token.", &opt_s3_session_token,
     &opt_s3_session_token, 0, GET_STR_ALLOC, REQUIRED_ARG, 0, 0, 0, 0, 0, 0},     
    ...
    {"google-session-token", OPT_GOOGLE_SESSION_TOKEN,
     ...
     &opt_google_session_token, 0, GET_STR_ALLOC, REQUIRED_ARG, 0, 0, 0, 0, 0, 0},     
