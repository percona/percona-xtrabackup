...
* `Bug #672384 <https://bugs.launchpad.net/bugs/672384>`_ - When no log files can be found in the backup directory while executing :option:`--stats`, a descriptive error message is printed instead of crashing. (Alexey Kopytov)
