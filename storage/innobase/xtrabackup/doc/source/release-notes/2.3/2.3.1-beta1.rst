...
----------
 ...
 :file:`.mylogin.cnf`. Bug fixed :jirabug:`PXB-413`.

 :option:`--decrypt` and :option:`--decompress` options didn't work with
 |xtrabackup| binary. Bug fixed :jirabug:`PXB-427`.
