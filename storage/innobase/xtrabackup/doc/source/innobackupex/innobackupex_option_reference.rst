...
.. option::  --compress-threads=#
   ...
   process. See the `xtrabackup` :doc:`documentation
   <../xtrabackup_bin/xtrabackup_binary>` for details.
...
.. option:: --decompress
   ...
   with the `innobackupex --compress` option. The `innobackupex
...
.. option:: --encrypt-chunk-size=#
   ...
   child process. See the `xtrabackup` :doc:`documentation
   <../xtrabackup_bin/xtrabackup_binary>` for more details.
...
.. option:: --incremental-history-uuid=UUID
   ...
   incremental backup on. `innobackupex
