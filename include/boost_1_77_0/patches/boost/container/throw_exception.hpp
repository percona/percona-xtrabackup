...
class BOOST_SYMBOL_VISIBLE exception : public ::std::exception {
  typedef ::std::exception std_exception_t;

 public:
  // msg must be a static string (guaranteed by callers)
  explicit exception(const char *msg) : std_exception_t(), m_msg(msg) {}
...
class BOOST_SYMBOL_VISIBLE bad_alloc : public exception {
 public:
  bad_alloc() : exception("boost::container::bad_alloc thrown") {}
};

typedef bad_alloc bad_alloc_t;

class BOOST_SYMBOL_VISIBLE out_of_range : public exception {
 public:
...
class BOOST_SYMBOL_VISIBLE length_error : public exception {
 public:
...
class BOOST_SYMBOL_VISIBLE logic_error : public exception {
 public:
  explicit logic_error(const char *msg) : exception(msg) {}
};

typedef logic_error logic_error_t;

class BOOST_SYMBOL_VISIBLE runtime_error : public exception {
 public:
...
//! requested storage space. <ul> <li>If BOOST_NO_EXCEPTIONS is NOT defined and
//! BOOST_CONTAINER_USE_STD_EXCEPTIONS is NOT defined
//!   <code>boost::container::bad_alloc(str)</code> is thrown.</li>
//!
//! <li>If BOOST_NO_EXCEPTIONS is NOT defined and
//! BOOST_CONTAINER_USE_STD_EXCEPTIONS is defined
...
//!   return.</li>
//! </ul>
BOOST_NORETURN inline void throw_bad_alloc() { throw bad_alloc_t(); }

//! Exception callback called by Boost.Container to signal arguments out of
//! range. <ul> <li>If BOOST_NO_EXCEPTIONS is NOT defined and
//! BOOST_CONTAINER_USE_STD_EXCEPTIONS is NOT defined
...
//! and BOOST_CONTAINER_USE_STD_EXCEPTIONS is NOT defined
