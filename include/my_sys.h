...
my_off_t my_get_ptr(uchar *ptr, size_t pack_length);
  ...
  #define init_io_cache_ext(A,B,C,D,E,F,G,H) \
    inline_init_io_cache_ext(A,B,C,D,E,F,G,H)
#else
  #define init_io_cache_ext(A,B,C,D,E,F,G,H) \
    inline_init_io_cache_ext(A,B,C,D,E,F,G)
#endif
extern int inline_init_io_cache_ext(IO_CACHE *info,File file,size_t cachesize,
